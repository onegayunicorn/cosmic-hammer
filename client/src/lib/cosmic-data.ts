...
export type ModuleKey = "overview" | "pressure" | "simulation" | "twin" | "agents" | "pipelines" | "webhooks" | "docs";
...
export const navItems: Array<{ key: ModuleKey; label: string; detail: string; icon: string }> = [
  ...
  { key: "pressure", label: "Pressure field", detail: "Model explorer", icon: "◎" },
...
export const bodies = [
  { name: "Helios", role: "Pressure source", pressure: "1.00e−11 Pa", stability: 98, color: "apricot" },
  { name: "Terra", role: "Twin anchor", pressure: "2.70e−06 Pa", stability: 92, color: "cyan" },
  { name: "Luna", role: "Field lens", pressure: "8.20e−08 Pa", stability: 81, color: "rose" },
];
